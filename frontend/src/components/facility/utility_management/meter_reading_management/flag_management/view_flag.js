...
function ViewFlag() {
  ...
  const handleSaveNotes = async () => {
    if (!notes) {
      toastify("Notes cannot be empty", "error");
      return;
    }
    try {
      setSavingNotes(true);
      const res = await makeAuthRequest(`${getFlagsURL}/${id}/notes`, "PATCH", {
        notes,
      });
      if (res.success) {
          ...
          <div className="row align-items-center">
            <div className="col-md-12">
              <ul className="breadcrumb mb-3">
                ...
                <li className="breadcrumb-item">
                  <Link to="/flags">Flag Management</Link>
                </li>
          ...
          <div className="col-md-6">
            <div className="card">
              ...
              <div className="card-body">
                ...
                <InfoRow
                  label="Resolved By"
                  value={flag.resolvedBy?.fullName}
                />
              </div>
            </div>
              ...
              <div className="card">
                ...
                <div className="card-body">
                  <InfoRow
                    label="Reading Value"
                    value={
                      flag.readingId?.value != null
                        ? `${flag.readingId.value} m³`
                        : null
                    }
                  />
                  <InfoRow
          ...
          <div className="col-md-6">
            <div className="card">
              ...
              <div className="card-body">
                <InfoRow
                  label="Serial Number"
                  value={flag.meterId?.serialNumber}
                />
                <InfoRow label="Meter Type" value={flag.meterId?.meterType} />
                <div className="mt-2">
                  <Link
                    to={`/meters/${flag.meterId?._id}`}
              ...
              <div className="card border-success">
                ...
                <div className="card-body">
                  <p className="text-muted mb-3">
                    Mark this flag as resolved once the issue has been
            ...
            {flag.status === "resolved" && (
              <div className="alert alert-success">
                ...
                This flag was resolved on{" "}
                <strong>
                  {new Date(flag.resolvedAt).toLocaleDateString()}
                </strong>
                {flag.resolvedBy?.fullName && (
                  <>
                    {" "}
                    by <strong>{flag.resolvedBy.fullName}</strong>
                  </>
                )}
                .
              </div>
